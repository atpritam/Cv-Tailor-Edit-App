      ...
      <head>
        ...
        <style>
          * {
          ...
          .consent { font-size: 10.5px; color: #6b7280; text-align: center; margin-top: 40px; }
          @media print { .consent { position: fixed; bottom: 20px; left: 0; right: 0; width: 100%; margin-top: 0; } }
